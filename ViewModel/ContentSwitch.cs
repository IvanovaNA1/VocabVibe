...
namespace VocabVibe.ViewModel
{
    public class ContentSwitch : Notify
    {
        ...
        public RelayCommand SetObject
        {
            get
            {
                return setObject ?? (setObject = new RelayCommand(obj =>
                {
                    ...
                    if ((obj as string) == "MainMenuView") MyContentControl = new MainMenuView();
                ...
                return selectedCategory ?? (selectedCategory = new RelayCommand(async obj =>
                {
                    try
                    {
                        if (obj is string category)
                        {
                            ...
                            {
                                case "Sport":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\Sport.txt";
                                    break;
                                case "City":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\City.txt";
                                    break;
                                case "Jobs":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\Jobs.txt";
                                    break;
                                case "Weather":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\WeatherCard.txt";
                                    break;
                                case "Character":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\Character.txt";
                                    break;
                                case "Apperiance":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\Appeariance.txt";
                                    break;
                                case "Family":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\FamilyCard.txt";
                                    break;
                                case "School":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\School.txt";
                                    break;
                                case "Mood":
                                    filePath = "C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\Mood.txt";
                                    break;
                            }
        ...
        public RelayCommand DontKnowCommand
        {
            get
            {
                return new RelayCommand(param =>
                {
                    if (ClickedTimes < WordsArray.Length - 1)
                    {
                        ...
                        SelectedTranslation = TranslatedWord;
                        using (StreamWriter sw = new StreamWriter("C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\Vocab.txt", true))
                        {
            ...
            get
            {
                return new RelayCommand(param =>
                {
                    if (ClickedTimes < WordsArray.Length - 1)
                    {
                        ...
                        WordsArray[ClickedTimes] = $"{EnglishWord}:{TranslatedWord}";
                        SelectedTranslation = TranslatedWord;
                        using (StreamWriter sw = new StreamWriter("C:\\Users\\Надежда\\Source\\Repos\\VocabVibe\\Files\\VocabTrue.txt", true))
                        {
                            sw.WriteLine(WordsArray[ClickedTimes]);
                        }
                    }
